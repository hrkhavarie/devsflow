                ...
                return(
                    ...
                    key={item.route}
                        className={`${isActive 
                            ...
                            flex items-center justify-start gap-4 bg-transparent p-4 hover:background-light800_dark100 rounded
                            `}
                    > 
                        <Image 
                            src={item.imgURL} 
                ...
                <div className="flex flex-col gap-3">
                        <Link href="/sign-in">
                            <Button className="small-medium btn-secondary min-h-[41px] w-full rounded-lg px-4 py-3 shadow-none">
                                <Image src='/assets/icons/signin.svg' alt='signin' width={20} height={20} className='invert-colors lg:hidden' />
                        ...
                        <Link href="/sign-up">
                            ...
                            <Image src='/assets/icons/sign-up.svg' alt='signin' width={20} height={20} className='invert-colors lg:hidden' />
